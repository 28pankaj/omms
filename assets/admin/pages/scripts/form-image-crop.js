var FormImageCrop = function () {
    ...
    var demo5 = function() {
        ...
        function initJcrop()//{{{
        {
          ...
          $('#demo5').Jcrop({
            ...
            Omms.updateUniform('#can_click,#can_move,#can_size');

            $('#ar_lock,#size_lock,#bg_swap').attr('checked',false);
            Omms.updateUniform('#ar_lock,#size_lock,#bg_swap');
    ...
    return {
        ...
        init: function () {
            ...
            Omms.addResizeHandler(handleResponsive);
            handleResponsive();

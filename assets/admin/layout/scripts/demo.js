...
var Demo = function() {
    ...
    var handleTheme = function() {
        ...
        if ($('.sidebar-pos-option').attr("disabled") === false) {
            $('.sidebar-pos-option', panel).val(Omms.isRTL() ? 'right' : 'left');
        }
        ...
        var setColor = function(color) {
            var color_ = (Omms.isRTL() ? color + '-rtl' : color);
    ...
    var setThemeStyle = function(style) {
        ...
        file = (Omms.isRTL() ? file + '-rtl' : file);

        $('#style_components').attr("href", Omms.getGlobalCssPath() + file + ".css");
